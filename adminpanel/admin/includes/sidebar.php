                    ...
                    <div class="scrollbar-sidebar" style="overflow-y: scroll; ">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <!-- <li class="app-sidebar__heading">ADD PROGRAMS</li>
                                <li>
                                    <a href="#">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" data-toggle="modal" data-target="#modalForAddProgram">
                                                <i class="metismenu-icon"></i>
                                                Add Programs
                                            </a>
                                        </li>
                                        <li>
                                        <a href="home.php?page=manage-program.php">
                                ...
                                <li class="app-sidebar__heading">MANAGE PROGRAM</li>
                                <li>
                                    <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         Program
