...
<!-- <div class="modal fade myModal" id="updateProgram-<?php echo $selProgramRow['pro_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
     <form class="refreshFrm" id="addProgramFrm" method="post" >
       <div class="modal-content myModal-content" >
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Update ( <?php echo $selProgramRow['pro_name']; ?> )</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group">
              <label>Program</label>
              <input type="" name="program_name" id="program_name" class="form-control" value="<?php echo $selProgramRow['pro_name']; ?>">
            </div>
          </div>
        </div>
        <div class="modal-footer">
     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Program</label>
            <input type="" name="course_name" id="course_name" class="form-control" placeholder="Input Program" required="" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="modal-footer">
...
<!-- 
          <div class="form-group">
            <label>Program</label>
            <input type="" value="pro" name="pro" class="form-control" placeholder="Input Program" required="">
          </div> -->
          ...
          <div class="form-group">
            ...
            <input type="" name="examTitle" class="form-control" placeholder="Input Course Title" required="">
          </div>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="year_level" id="year_level">
              ...
              <option value="eight year">eigth Year</option>
            </select>
          </div>
          <div class="form-group">
            <label>Email</label>
