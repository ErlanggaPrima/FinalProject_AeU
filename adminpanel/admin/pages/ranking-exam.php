                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div><b class="text-primary">RANKING BY EXAM</b><br>
                               ...
                               <span class="border" style="padding:10px;color:white;background-color: green ;border-radius: 5px;">Top 3</span>

                               <span class="border" style="padding:10px;color:white;background-color: orange ;border-radius: 5px;">Excellence</span>
                               <span class="border" style="padding:10px;color:black;background-color: yellow ;border-radius: 5px;">Very Good</span>
                               <span class="border" style="padding:10px;color:white;background-color: blue ;border-radius: 5px;">Good</span>
                               <span class="border" style="padding:10px;color:white;background-color: red ;border-radius: 5px;">Failed</span>
                               <span class="border" style="padding:10px;color:black;background-color: #E9ECEE ;border-radius: 5px;">Not Answering</span>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4">Course Title</th>
